#!/usr/bin/env python3
"""
Eenmalige inhaal: zet de KTM-verkoopprijs op Motox-producten van KTM,
Husqvarna, GasGas en WP die niet op de Online Store staan (Synkro/POS).

Synkro kopieert prijswijzigingen daarna zelf. Deze run is alleen voor de
delta van vóórdat Price-sync aan stond. Geen uurschema.
